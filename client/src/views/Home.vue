    ...
    <!-- <hello-world></hello-world> -->
      <v-container fluid width="85vw">
        ...
        <v-row class="mt-8 ml-10" >            
          <v-col class="pl-1" cols="12" md="8">
            <v-row d-flex justify="center">
              <h2>Vatten Nyhetrena</h2>
            </v-row>
            <v-row d-flex flex-wrap>
              <v-col cols="12" md="12">
                <v-list-item
                v-for="event in events" :key="event.title" class="ma-2">
                  <v-card class="mx-auto ma-1 newslist" outlined>
                    <v-col cols="12" md="3" class="mt-2" d-flex align="center" justify="center">
                      <v-img :src="require('@/assets/homeimages/' + event.image)" width="200px" height="200px"></v-img>
                    </v-col>
                    <v-col cols="12" md="9">

                          <v-list-item-content class="ma-4">
                            <v-list-item-title class="headline mb-1">{{event.title}}</v-list-item-title>
                            <v-list-item-subtitle class="ma-1">{{event.new_date}}</v-list-item-subtitle>
                          </v-list-item-content>
                          <v-list-item-content class="ma-4">{{event.description}}
                            <v-list-item-subtitle>{{event.company}}</v-list-item-subtitle>
                          </v-list-item-content>
