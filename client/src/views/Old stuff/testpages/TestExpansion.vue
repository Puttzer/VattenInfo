...
export default {
    ...
    packets: [
      {
        title: "BAS",
        price: "695 kr",
        tests: ["klorid", "Järn", "PH", "Turbiditet", "Total hårdhet"],
      },
      {
        title: "FAMIJ",
        price: "950 kr",
  ...
  computed: {
    testDescription() {
      const tests = this.singleTests.map((test) => test.tests);
      console.log(tests);
      return tests;
    },
  },
