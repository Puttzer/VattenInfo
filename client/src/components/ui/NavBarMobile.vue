<template>
  <div>
    ...
    <v-navigation-drawer
      ...
      width="100%"
    >
      <v-icon large color="white" class="mx-6 mt-7" @click="drawer = !drawer"
        >mdi-close</v-icon
      >
      <v-row class="pl-12">
        <v-col class="pl-12">
          <v-list class="pl-12">
            <v-list-group class="pt-3" no-action sub-group>
              <template v-slot:activator>
                <v-list-item-content>
                  <v-list-item-title class="pr-9 white--text"
                    >Meny</v-list-item-title
                  >
                </v-list-item-content>
              </template>
            ...
            <v-list-item>
              <v-list-item-title class="white--text"
                >Instruktioner & Blanketter</v-list-item-title
              >
            </v-list-item>

            <v-list-item>
              <v-list-item-title class="white--text"
                >Hjälp med ditt vatten</v-list-item-title
              >
            </v-list-item>

            <v-list-item>
              <v-list-item-title class="white--text"
                >Om Laboratoriet</v-list-item-title
              >
            </v-list-item>
          </v-list>
        </v-col>
...
export default {
  data() {
    return {
      ...
      english: false,
      links: [
        { text: "Enskillt Dricksvatten", route: "/enskillt_vatten" },
